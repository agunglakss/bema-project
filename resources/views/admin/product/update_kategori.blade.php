	...
	<section class="section">
      ...
      <div class="section-body">
         ...
         <div class="row">
            <div class="col-12">
               <div class="card">
                  <form class="needs-validation" novalidate="" method="post" action="{{ url('/products/kategori-motor') }}/{{ $kategori->slug }}/edit">
                     @method('patch')
                     @csrf
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <select class="form-control selectric" name="nama_tipe" required="">
                              ...
                              <option value="{{ old('nama_tipe') ?? $tipeMotor->id }}"
                                 @if($tipeMotor->id == $kategori->tipe_id) selected="selected"@endif
                                 >{{ $tipeMotor->nama_tipe }}</option> 
                              @empty
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input type="text" class="form-control" name="nama_kategori" value="{{ old('nama_kategori') ?? $kategori->nama_kategori }}" placeholder="Isi dengan Honda Beat, Honda Vario dan lain-lain." {{ old('nama_kategori') }} required="">
                           <div class="invalid-feedback">
