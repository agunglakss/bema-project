						...
						<form class="needs-validation" novalidate="" method="post" action="{{ url('/banners').'/'.$banner->id.'/edit' }}" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<img width="100" height="100px" src="{{ asset('/storage/banner-image/'.$banner->image) }}" alt="{{ $banner->image }}">
										<input class="form-control mt-2" type="file"  name="image" style="padding:7px 0 0 5px;">
										<span class="text-small">Ukuran image harus 1440 x 360 pixel, maksimum image 3 MB.</span><br>
										<span class="text-small">Biarkan kosong jika image tidak ingin diubah.</span>
